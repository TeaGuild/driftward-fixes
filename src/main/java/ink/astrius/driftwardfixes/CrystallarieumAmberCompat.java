...
public class CrystallarieumAmberCompat extends SpectrumIntegrationPacks.ModIntegrationPack {
    public static DeferredBlock<SpectrumClusterBlock> SMALL_AMBER_BUD = Driftward.registerBlock(
        "small_amber_bud",
    ...
    public static DeferredBlock<SpectrumClusterBlock> LARGE_AMBER_BUD = Driftward.registerBlock(
        "large_amber_bud",
        () -> new SpectrumClusterBlock(
    ...
    public static DeferredBlock<SpectrumClusterBlock> AMBER_CLUSTER = Driftward.registerBlock(
        "amber_cluster",
        () -> new SpectrumClusterBlock(
            BlockBehaviour.Properties.ofFullCopy(SMALL_AMBER_BUD.get()),
    ...
    public static DeferredBlock<Block> PURE_AMBER_BLOCK = Driftward.registerBlock(
        "pure_amber_block",
        () -> new Block(
    ...
    public static DeferredItem<Item> PURE_AMBER = Driftward.ITEMS.registerSimpleItem(
        "pure_amber"
    );
